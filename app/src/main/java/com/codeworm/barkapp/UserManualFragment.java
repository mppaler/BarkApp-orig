...
public class UserManualFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        list.add(new Card("drawable://" + R.drawable.bicycle_logo, "If you are registered in the slot and someone tried to steal your bike, the user will be receiving an SMS message to inform that there is an unexpected action that happened to his bike ","4. SMS Notification \n(for registered only)"));
