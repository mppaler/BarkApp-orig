...
public class ForgotPasswordPageThreeActivity extends AppCompatActivity {
    ...
    public void changePassword(final String sNewPassword){
        final LoadingDialog loadingDialog = new LoadingDialog(ForgotPasswordPageThreeActivity.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getString("error").equals("false")){
                                ...
                                Intent intent = new Intent(ForgotPasswordPageThreeActivity.this, LoginActivity.class);
